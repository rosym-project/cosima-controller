...
class qp_problem_cart_wo_js {

public:
    qp_problem_cart_wo_js(const XBot::ModelInterface::Ptr model, const Eigen::VectorXd &q) {
        ...
        stack.reset(new OpenSoT::AutoStack(cart_imped_high));
