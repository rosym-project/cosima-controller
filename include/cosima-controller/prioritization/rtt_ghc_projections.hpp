...
namespace cosima
{
    ...
    namespace prioritization
    {
        ...
        public:
            ...
            double getAlphaLastEntry();
            void showHierarchy();

            std::vector<Eigen::MatrixXd> jacobian;

            // void iterativelyBuildJaugmented(const Eigen::MatrixXd &J, const unsigned int taskNumber);
            void getJaugmented(Eigen::MatrixXd &Jaugmented);

            Eigen::MatrixXd getInertiaMatrixInv();
        ...
        private:
            ...
            unsigned int Jaugmented_task_pos;
        };
