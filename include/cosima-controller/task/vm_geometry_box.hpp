...
class VMGeometryBox : public VMGeometry
{
public:
  VMGeometryBox();
  // ~VMGeometryBox();
...
private:
  std::vector<Eigen::Vector3d> relativeFinger2ObjectTranslation;
  std::vector<Eigen::Matrix<double, 3, 3>> relativeFinger2ObjectRotation33;
};
